...
import (
	...
	"github.com/legend1250/postgres-graphql/gql"
	"github.com/legend1250/postgres-graphql/postgres"
	"github.com/legend1250/postgres-graphql/server"
)
...
func initializeAPI() (*chi.Mux, *postgres.Db) {
	...
	db, err := postgres.New(
		postgres.ConnString("localhost", 5432, "postgres", "123456", "postgres"),
	)
	if err != nil {
		log.Fatal(err)
	}
